...
class ColorResources {
  static const Color COLOR_GREY = Color(0xFFA9A9A9);
  static const Color COLOR_BUTTON_BACKGROUND = Color(0xFFF7F7F7);
  static const Color COLOR_DEFAULT = Color(0xFFE1E9F3);
  static const Color COLOR_LIGHT_GREY = Color(0xFF8D8D9C);
  static const Color COLOR_BLACK = Color(0xFF2D2D2D);
  ...
  static const Color COLOR_SEARCH_BG = Color(0xFFF4F7FC);
  static const Color COLOR_DIVIDER = Color(0xFFE3E3E1);
  static const Color COLOR_TAB_BG = Color(0xFFF5F5F5);
  ...
  static const Color APPBAR_HEADER_COLOR = Color(0xFFFC6A57);
  ...
  static const Color COLOR_BLUE = Color.fromARGB(255, 124, 168, 230);
